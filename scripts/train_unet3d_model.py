...
model_checkpoint = ModelCheckpoint(model_path+'unet3d_validate.hdf5', monitor='loss', save_best_only=True)
#
# Should we load existing weights? 
# Set argument for call to train_and_predict to true at end of script
if use_existing:
    model.load_weights(model_path+'unet3d_validate.hdf5')
...
model.save(model_path+'model_validate_unet3d.h5')
...
model_checkpoint = ModelCheckpoint(model_path+'unet3d_train.hdf5', monitor='loss', verbose = 1, save_best_only=True)
print('-'*30)
...
model.save(model_path+'model_train_unet3d.h5')
...
with open(model_path+"model_unet3d.json", "w") as json_file:
    json_file.write(simplejson.dumps(simplejson.loads(model_json), indent=4))

# serialize weights to HDF5
model.save_weights(model_path+"model_unet3d.h5")
