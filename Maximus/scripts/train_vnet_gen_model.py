...
from keras.layers import merge, add, Convolution2D, MaxPooling2D, Input, UpSampling2D
...
validate_model_weights = 'vnet_%d_validate.hdf5' % img_width
validate_model = 'model_validate_vnet_%d.h5' % img_width

train_model_weights = 'vnet_%d_train.hdf5' % img_width
train_model = 'model_train_vnet_%d.h5' % img_width
